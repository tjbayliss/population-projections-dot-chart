...
var aleph = {
  ...
  */
  ...
  axisMainTitles: {
    ...
    dotChart: { x: "Percentage of total UK population", y: "Region" },
  },
  /* currentChart: "line", */
  /*   currentChart: "pyramid", */
  currentChart: "dots",
  mainChart: null,
  /*
  LINE CHART
  */
  ...
  sparkLineToolTipDimensions: {
    /* dimension and positioning attributes for tooltip */ width: 350,
    height: 300,
  ...
  toolTipDimensions: {
    /* dimension and positioning attributes for tooltip */ width: 395,
    height: 225,
    verticalLabelSpacing: 35 /* vertical spacing between text lines */,
    margin: { top: 100, right: 20, bottom: 5, left: 20 },
    informationArray:
  ...
  */
  ...
  xAxisMaximums: {
    ...
    roundings: { count: 100000, percent: 0.2 },
  },
...
/*     "#14022E",
  ...
  mergedAgeBandSymbolWidth: 25,
  dotAxisMax: { expand: 25, contract: 3.5 },
  dotAxisType: "UK",
  source: null,
  target: null,
  newSwatchWidth: 100,
  newSwatchHeight: 25,
  MASTERnestedDotObject: [],
  CLONEDnestedDotObject: [],
  /*  xAxisMax:-Infinity */
  xAxisMax: { REGION: -Infinity, UK: -Infinity },
  nonDisplayedAgeBands:[],
};
